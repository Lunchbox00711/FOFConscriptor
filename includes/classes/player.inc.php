...
NULL) player_pos_drill_style';
        ...
        $joins[] = "left join player_comments on player_comments.team_id = '".mysqli_real_escape_string($mysql, $login->team_id())."' and
player_comments.player_id = player.player_id";
        $col[] = "player_comments.player_comments_text";

        $joins[] = "left join team_player on team_player.player_id = player.player_id and team_player.team_id = '".mysqli_real_escape_string($mysql, $login->team_id())."'";
...
player_comments.player_id = staff.staff_id";
        ...
        $joins[] = "left join team_player on team_player.player_id = staff.staff_id and team_player.team_id = '".mysqli_real_escape_string($mysql, $login->team_id())."'";
...
<p>Currently in your selection set, priority '.$row['selection_priority'];
    ...
    public function get_affinity($dob)
    {
        ...
        if ($dob) {
            ...
            } elseif (($dobarray[1] == 4 && $dobarray[2] > 20) || ($dobarray[1] == 5 && $dobarray[2] < 22)) {
                $html .= '2/19-3/20 and also 6/22-7/23.';//Taurus
            } elseif (($dobarray[1] == 5 && $dobarray[2] > 21) || ($dobarray[1] == 6 && $dobarray[2] < 22)) {
                $html .= '3/21-4/20 and also 10/24-11/22.';//Gemini
            } elseif (($dobarray[1] == 6 && $dobarray[2] > 21) || ($dobarray[1] == 7 && $dobarray[2] < 24)) {
                $html .= '2/19-3/20 and also 4/21-5/21.';//Cancer
            } elseif (($dobarray[1] == 7 && $dobarray[2] > 23) || ($dobarray[1] == 8 && $dobarray[2] < 24)) {
                $html .= '11/23-12/22 and also 8/24-9/23.';//Leo
            } elseif (($dobarray[1] == 8 && $dobarray[2] > 23) || ($dobarray[1] == 9 && $dobarray[2] < 24)) {
                $html .= '11/23-12/22 and also 7/24-8/23.';//Virgo
            } elseif (($dobarray[1] == 9 && $dobarray[2] > 23) || ($dobarray[1] == 10 && $dobarray[2] < 24)) {
                $html .= '1/21-2/20 and also 12/23-1/20.';//Libra
            } elseif (($dobarray[1] == 10 && $dobarray[2] > 23) || ($dobarray[1] == 11 && $dobarray[2] < 23)) {
                $html .= '3/21-4/20 and also 5/22-6/21.';//Scorpio
            } elseif (($dobarray[1] == 11 && $dobarray[2] > 22) || ($dobarray[1] == 12 && $dobarray[2] < 23)) {
                $html .= '7/24-8/23 and also 8/24-9/23.';//Sagitarius
            } elseif (($dobarray[1] == 12 && $dobarray[2] > 22) || ($dobarray[1] == 1 && $dobarray[2] < 21)) {
                $html .= '1/21-2/20 and also 9/24-10/23.';//Capricorn
            } elseif (($dobarray[1] == 1 && $dobarray[2] > 20) || ($dobarray[1] == 2 && $dobarray[2] < 19)) {
                $html .= '12/23-1/20 and also 9/24-10/23.';//Aquarius
            } elseif (($dobarray[1] == 2 && $dobarray[2] > 18) || ($dobarray[1] == 3 && $dobarray[2] < 21)) {
  ...
  <!--<tr>
    ...
    <td>'.$row['player_experience'].'</td>
      ...
      <tr>
        ...
        $bar_array = ["Popularity" => 'player_popularity',
    ...
    public function draw_staff_data(&$row)
    {
        global $mysql;
...
<table align="center">
  ...
  <tr>
    ...
    <td>'.$row['staff_pri_group_name'].'</td>
        ...
        $text_array = ["staff_player_dev" => "Player Development",
        ...
        foreach ($text_array as $key => $title) {
            if ($row[$key]) {
                ...
                } elseif (calculate_round() == 2 && (strcmp($title, "Suitable Off. Coord") == 0 || strcmp($title, "Player Development") == 0 ||
                    strcmp($title, "Play Calling") == 0 || strcmp($title, "Scouting") == 0 || strcmp($title, "Interviewing") == 0)) {
                    $head = '<div class="important_staff">';
                } elseif (calculate_round() == 3 && (strcmp($title, "Suitable Def. Coord") == 0 || strcmp($title, "Player Development") == 0 ||
                    strcmp($title, "Play Calling") == 0 || strcmp($title, "Scouting") == 0 || strcmp($title, "Interviewing") == 0)) {
                    $head = '<div class="important_staff">';
                } elseif (calculate_round() == 4 && (strcmp($title, "Suitable Ast. Coach") == 0 || strcmp($title, "Player Development") == 0 ||
                    strcmp($title, "Scouting") == 0 || strcmp($title, "Interviewing") == 0)) {
                    $head = '<div class="important_staff">';
                } elseif (calculate_round() == 5 && (strcmp($title, "Suitable Str. Coord") == 0 || strcmp($title, "Strength Training") == 0 ||
    ...
    public function draw_hiddenattributes(&$row)
    {
...
<table align="center" padding="5">
   ...
   <table align="center">';
        $text_array = ["player_character" => "Character Issues"];
        foreach ($text_array as $key => $title) {
            if ($row[$key]) {
