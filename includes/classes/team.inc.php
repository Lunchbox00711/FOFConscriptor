...
class team
{
    ...
    public function team_user_link()
    {
        return $this->data['team_user_link'];
    }
  
    public function team_is_draft_admin()
    {
...
('".$mock_pick_id."', '".$this->data['team_id']."', '".$row['player_id']."', '$commentary')";
    ...
    {
        $tough = ["This was a tough one to call.",
           "Tough one to call.",
        ...
        $justaseasy = ["might just as easily go with",
        ...
        $hardtopass = ["would be hard to pass up here.",
...
there really isn't a better choice at this point.";
    ...
    {
        $could_have = ["they could have easily gone with",
             "they might go with",
